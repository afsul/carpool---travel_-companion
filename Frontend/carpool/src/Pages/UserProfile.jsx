...
<div >
  ...
  <Box style={{display:"flex",justifyContent:"center"}}
    ...
    >
      ...
      <TextField className='about-form-field' id="filled-basic" value={userData.first_name} label="First name" variant="filled"  /> 
      <TextField id="standard-basic" label="Last name" variant="filled" value={userData.last_name} />
    ...
    >
      {/* <TextField id="outlined-basic" label="Outlined" variant="outlined" /> */}
      <TextField className='about-form-field' id="filled-basic" value={user.username} label="Username" variant="filled" />
      <TextField id="standard-basic" label="Email" value={user.email} variant="filled" />
    ...
    >
      {/* <TextField id="outlined-basic" label="Outlined" variant="outlined" /> */}
      <TextField className='about-form-field' id="filled-basic" value={userData.phone} label="Phone" variant="filled" />
